# THIS IS THE CODE FOR IMPUTATION USING MODE IMPUTATION. THE CODE SHOWN IS ON TRAINING DATA ON HEALTHY V BENIGN BUT THE SAME CODE WAS 
...
train_df_imputed.to_csv('train_hb_mode.csv', index=False)
